  ...
  return (
    <footer className="border-t border-amber-100/60 bg-white/70 mt-auto dark:border-amber-900/30 dark:bg-gray-950/70">
      <div className="mx-auto max-w-5xl px-4 py-12">
        <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-gray-500 dark:text-gray-400">
              ...
              <li>
                <Link href="/memorials" className="hover:text-amber-600 dark:hover:text-amber-400 transition-colors">
                  Community
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-10 border-t border-amber-100/60 dark:border-amber-900/30 pt-6 text-center">
